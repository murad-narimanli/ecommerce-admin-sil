...
import { Button, Select, Modal , Form, Input ,Card, Row , Col, Switch } from 'antd';
import {
...
const MainSlider = ( ) => {
    ...
    const deleteData = (data) => {
        client.delete(`sliderimages/${data.id}`)
        .then((res) => {
                    ...
                    data.map((d)=>{
                        return (
                            ...
                            actions={[
                                ...
                                //     editData(d)
                                // }} key="edit" />,
                                 <DeleteOutlined onClick={() => { deleteData(d) }} key="delete" 
    ...
    {data.map((d) => (
        <Card
            ...
            actions={[                <DeleteOutlined onClick={() => { deleteData(d) }} key="delete" />,             ]}
        />
    ))}
</div>
